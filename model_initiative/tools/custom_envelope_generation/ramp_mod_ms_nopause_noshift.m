...
%               2 to delay sustain
function out = ramp_mod_ms_nopause_noshift(len,fs,fc,parameters,dp,env_min,env_max,flank_type,is_reference,dp_location)
...
% 
% filename_ramp=sprintf('env%d.mat',cputime);
% envelope=[ramp_l ramp_r];
% save(filename_ramp,'envelope')
